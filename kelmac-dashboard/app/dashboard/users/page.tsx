...
export default function page() {
  ...
  const columns = [
    ...
    {
      displayName: "Email",
      displayField: (e:any) => <div className="text-lowercase">{e?.email}</div>,
      searchable: true,
    },

    {
      displayName: "Role",
      displayField: (e:any) => (
        <span className="badge bg-primary text-capitalize">{e?.role}</span>
      ),
      searchable: true,
    },

    {
      ...
      displayField: (e:any) => (
        <>
          {e?.status === "Active" && (
            <span className="badge bg-success text-capitalize">{e.status}</span>
          )}
          {e?.status === "Blocked" && (
            <span className="badge bg-danger text-capitalize">{e.status}</span>
          )}
          {e?.status === "Pending" && (
              ...
              <div className="card-header py-3 bg-gradient">
                <div className="row">
                  ...
                  <div className="col-auto">
                    <Link href="/dashboard/users/create" className=" btn btn-dark btn-sm">
                      <svg
