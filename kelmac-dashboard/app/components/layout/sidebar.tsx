    ...
    <div id="sidebar-menu" className="sidebar-menu">
       <ul className="nav nav-pills flex-column mb-auto">
        <li className="nav-item">
          <Link href="/" className="nav-link active text-white" aria-current="page">
            <i data-feather="home" className="me-2" />
            Dashboard
          </Link>
        </li>
        <li>
          <Link href="/client" className="nav-link text-white">
            <i data-feather="users" className="me-2" />
            Client
          </Link>
        </li>
        <li>
          <Link href="/companies" className="nav-link text-white">
            <i data-feather="briefcase" className="me-2" />
            Companies
          </Link>
        </li>
        <li>
          <Link href="/plan" className="nav-link text-white">
            <i data-feather="clipboard" className="me-2" />
            Plan
          </Link>
        </li>
        <li>
          <Link href="/subscription" className="nav-link text-white">
